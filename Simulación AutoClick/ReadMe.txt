========================================================================
    APLICACIÓN DE CONSOLA: Simulación AutoClick Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación Simulación AutoClick.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación Simulación AutoClick.


Simulación AutoClick.vcxproj
...
Simulación AutoClick.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado Simulación AutoClick.pch y un archivo de tipos precompilados llamado StdAfx.obj.
